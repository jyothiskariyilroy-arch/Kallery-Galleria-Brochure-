...
export default function WhatsAppFloat() {
  ...
  const phone = "919495040824";
  const message = encodeURIComponent(
    "Hi, I'm interested in Kallery Galleria. Please share investment details."
  );
  ...
  return (
    ...
    >
      {/* Label */}
      <motion.span
        className="glass text-ivory/60 font-mono text-[0.6rem] uppercase tracking-widest px-4 py-2 rounded-full whitespace-nowrap"
