  ...
  return (
    <section ref={ref} id="contact" className="relative py-48 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-12 text-center">
        ...
        <motion.h2
          className="font-cormorant text-6xl md:text-7xl lg:text-8xl font-light leading-tight mb-6"
        ...
        >
          This is your
          <br />
          <span className="gold-shimmer">commercial edge.</span>
        </motion.h2>

        <motion.p
          className="text-ivory/30 font-dm text-base leading-relaxed max-w-lg mx-auto mb-16"
          initial={{ opacity: 0 }}
          animate={inView ? { opacity: 1 } : {}}
          transition={{ delay: 0.4, duration: 0.8 }}
        >
          12,000 sq ft. Main road. Fully permitted. Available now.
          The window to secure this asset is open — not indefinitely.
        </motion.p>

        {/* CTA Block */}
        <motion.div
          className="glass-gold rounded-3xl p-12 max-w-2xl mx-auto"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+918289830824" className="btn-outline-gold">
